...
("lulu_api_key", "Lulu.com API key", "input[type=text]", None, "lulucom", "", lambda x: len(x) < 999 and is_utf8(x), config.LULU_API_KEY),
("lulu_user", "Lulu.com user", "input[type=text]", None, "lulucom", "", lambda x: len(x) < 999 and is_utf8(x), config.LULU_USER),
("lulu_password", "Lulu.com password", "input[type=text]", None, "lulucom", "", lambda x: len(x) < 999 and is_utf8(x), config.LULU_PASSWORD),
("lulu_project", "Lulu.com project number", "input[type=text]", None, "lulucom", "", lambda x: len(x) < 999 and is_utf8(x), None),
("cover_url", "URL for cover image", "input[type=text]", None, "", "", lambda x: len(x) < 999 and is_utf8(x), None),
("to_lulu", "Send to lulu.com", "input[type=checkbox]", 'yes', "", '', u"yes".__eq__, None),
("copyright_year", "Copyright year", "input[type=text]", None, "lulucom", "", is_int_or_auto, None),
("copyright_citation", "Copyright citation", "input[type=text]", None, "lulucom", "", lambda x: len(x) < 999 and is_utf8(x), None),
("lulu_license", "License for lulu.com", "input[type=text]", None, "lulucom", "", lambda x: len(x) < 999 and is_utf8(x), None),
("lulu_access", "Access at lulu.com", "input[type=text]", None, "lulucom", "", lambda x: len(x) < 999 and is_utf8(x), "private"),
("lulu_allow_ratings", "Allow ratings at lulu.com", "input[type=checkbox]", None, "lulucom", "", u"yes".__eq__, None),
("lulu_color", "Color for lulu.com", "input[type=checkbox]", None, "lulucom", "", u"yes".__eq__, None),
("lulu_drm", "DRM for lulu.com", "input[type=checkbox]", None, "lulucom", "", u"yes".__eq__, None),
("lulu_paper_type", "Paper type for lulu.com", "input[type=text]", None, "lulucom", "", lambda x: len(x) < 999 and is_utf8(x), "publisher-grade"),
("lulu_binding_type", "Binding type for lulu.com", "input[type=text]", None, "lulucom", "", lambda x: len(x) < 999 and is_utf8(x), "perfect"),
("lulu_language", "Language for lulu.com", "input[type=text]", None, "lulucom", "", lambda x: len(x) < 999 and is_utf8(x), "EN"),
("lulu_keywords", "Keywords for lulu.com", "input[type=text]", None, "lulucom", "", lambda x: len(x) < 999 and is_utf8(x), None),
("lulu_currency_code", "Currency code for lulu.com", "input[type=text]", None, "lulucom", "", lambda x: len(x) < 999 and is_utf8(x), None),
("lulu_download_price", "Download price for lulu.com", "input[type=text]", None, "lulucom", "", lambda x: len(x) < 999 and is_utf8(x), None),
("lulu_print_price", "Print price for lulu.com", "input[type=text]", None, "lulucom", "", lambda x: len(x) < 999 and is_utf8(x), None),
("description", "Description", "input[type=text]", None, "lulucom", "", lambda x: len(x) < 999 and is_utf8(x), None),
("authors", "Authors", "input[type=text]", None, "lulucom", "", lambda x: len(x) < 999 and is_utf8(x), None),
