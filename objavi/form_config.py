...
("copyright_year", "Copyright year", "input[type=text]", None, "", "", is_int_or_auto, None),
("copyright_citation", "Copyright citation", "input[type=text]", None, "", "", lambda x: len(x) < 999 and is_utf8(x), None),
("lulu_license", "License for lulu.com", "input[type=text]", None, "", "", lambda x: len(x) < 999 and is_utf8(x), None),
("lulu_access", "Access at lulu.com", "input[type=text]", None, "", "", lambda x: len(x) < 999 and is_utf8(x), "private"),
("lulu_allow_ratings", "Allow ratings at lulu.com", "input[type=checkbox]", None, "", "", u"yes".__eq__, None),
("lulu_color", "Color for lulu.com", "input[type=checkbox]", None, "", "", u"yes".__eq__, None),
("lulu_drm", "DRM for lulu.com", "input[type=checkbox]", None, "", "", u"yes".__eq__, None),
("lulu_paper_type", "Paper type for lulu.com", "input[type=text]", None, "", "", lambda x: len(x) < 999 and is_utf8(x), "publisher-grade"),
("lulu_binding_type", "Binding type for lulu.com", "input[type=text]", None, "", "", lambda x: len(x) < 999 and is_utf8(x), "perfect"),
("lulu_language", "Language for lulu.com", "input[type=text]", None, "", "", lambda x: len(x) < 999 and is_utf8(x), "EN"),
("lulu_keywords", "Keywords for lulu.com", "input[type=text]", None, "", "", lambda x: len(x) < 999 and is_utf8(x), None),
("lulu_currency_code", "Currency code for lulu.com", "input[type=text]", None, "", "", lambda x: len(x) < 999 and is_utf8(x), None),
("lulu_download_price", "Download price for lulu.com", "input[type=text]", None, "", "", lambda x: len(x) < 999 and is_utf8(x), None),
